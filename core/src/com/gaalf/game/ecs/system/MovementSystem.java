...
public class MovementSystem extends IteratingSystem {
    ...
    protected void processEntity(Entity entity, float deltaTime) {
        ...
        if (movementComponent.isMoved()){
            ...
            bodyComponent.body.applyLinearImpulse(new Vector2(movementComponent.getForceX() / 100, movementComponent.getForceY() / 100), new Vector2(GaalfGame.V_WIDTH/2, GaalfGame.V_HEIGHT/2), true);
